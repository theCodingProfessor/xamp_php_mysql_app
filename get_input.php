...
echo '<html lang="en">';
echo '<head>';
echo '    <title>GET: PHP MySQL App</title>';
...
echo '<body>';
echo '<br/>';
echo '<h1 class="h1_title">GET web form method demonstration</h1> <hr/>';
...
echo '<br>';
echo '<div class="container" id="get_form_db_update"> <!-- web form container -->';
echo '    <div class="row">';
echo '        <div class="col-sm-1"></div> <!-- left main grid column -->';
echo '        <div class="col-sm-10">';
echo ' <hr/>';
echo '            <div class="container-fluid">';
echo '            <form action="update_by_get.php" method="get"><br/>';
echo '            <textarea type="text" name="response_text" id="response_text" placeholder="Insert text here..." rows="2" cols="80"></textarea>';
echo '            <input type="submit" value="Send GET to Database">';
echo '            </form>';
echo '            </div></div><!-- end of sm 10 grid -->';
echo '        <div class="col-sm-1"></div> <!-- right main grid column -->';
echo '    </div> <!-- end div row  -->';
...
echo '    <div class="row"><div class="col-sm-1"></div> <!-- left main grid column -->';
echo '        <div class="col-sm-10">';
echo '            <footer><article><br/><hr/><p id="footer_here">This xamp demo is free to use &copy; Clinton Garwood 2022 -' . date("Y") . '</p></article></footer>';

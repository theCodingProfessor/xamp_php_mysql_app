...
<body>
<br/>
<h1 class="h1_title">Welcome to the Demo PHP MySQL App</h1> <hr/>
...
<div class="container" id="forming"> <!-- web form container -->
    <div class="row">
        ...
        <div class="col-sm-10">
            <div class="container-fluid">
                <article><br/><p>This application demonstrates basic features of the PHP/MySQL/Apache stack known as XAMPP<p>
                    <p>Feature demonstrations include:<p>
                    <ul></li>Web Form Submissions: GET and POST (basic text transfer)</li><br/>
                        </li>Database Updates by: GET and POST (web form submissions)</li><br/>
                        </li>Reading Data from a MySQL database</li><br/>
                        </li>Updating and Deleting Data from a MySQL database</li></ul></article><br/>

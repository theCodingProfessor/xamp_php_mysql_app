...
echo '<html lang="en">';
echo '<head>';
echo '    <title>POST Response</title>';
...
echo '<body>';
echo '<br/>';
echo '<h1 class="h1_title">POST Web Form Response</h1> <hr/>';
...
echo '        <div class="col-sm-10">';
echo '            <div class="container-fluid">';
echo '            <p>GET form submission data: ' . '<br>' . 'The information received was: ' . $_POST["response_text"]  . '<br></p>';
